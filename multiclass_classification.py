...
#other_components = sorted(list(set(other_components)))
#print("Other count: ", len(other_components))
#for other in other_components:
#    name = define_go_term(other)
#    if len(name) > 0:
#        print(other + ": " + name)
#    else:
#        print(other + ": not in json file")
