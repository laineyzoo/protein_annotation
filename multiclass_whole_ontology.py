...
k_fold_validation(K, labels_cc, abstracts_cc, pmids_dataset_cc)
print("\n-------Train and Test for BIOLOGICAL PROCESS-------\n")
k_fold_validation(K, labels_bp, abstracts_bp, pmids_dataset_bp)
print("\n-------Train and Test for MOLECULAR FUNCTION-------\n")
k_fold_validation(K, labels_mf, abstracts_mf, pmids_dataset_mf)
