...
for i in range(len(ids)):
	...
	print("Time: ", time()-time_start_test)
...
if save_results == "Y":
	results_dict = {}
	with open("results/true_labels_GO_"+ont+"_"+dataset+"_trunc.json","w") as f:
...
for r in range(1,101):
	...
	if save_results=="Y":
		with open("results/predicted_labels_GO_"+ont+"_"+dataset+"_"+str(thresh)+"_trunc.json","w") as f:
...
#save output to file
f = open("log_GO_"+ont+"_"+dataset+"_"+algo+"_"+str(test_len)+"_trunc.txt","w")
print("\n-----Results-----", file=f)
